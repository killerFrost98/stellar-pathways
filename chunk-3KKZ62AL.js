...
`].filter(hs).join(`
`)),a=Oo(a),a=kc(a,e),a=Hc(a,e),o=Oo(o),o=kc(o,e),o=Hc(o,e),a=Gc(a),o=Gc(o),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
}`;function Wg(i,t,e){let n=new Sr,s=new vt,r=new vt,a=new ae,o=new zo({depthPacking:Iu}),l=new ko,c={},h=e.maxTextureSize,d={[Fn]:ye,[ye]:Fn,[Je]:Je},f=new xe({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new vt},radius:{value:4}},vertexShader:Hg,fragmentShader:Gg}),m=f.clone();m.defines.HORIZONTAL_PASS=1;let g=new fe;g.setAttribute("position",new Oe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new se(g,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rh;let u=this.type;this.render=function(C,A,D){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;let S=i.getRenderTarget(),x=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),z=i.state;z.setBlending(Nn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);let O=u!==pn&&this.type===pn,W=u===pn&&this.type!==pn;for(let Y=0,G=C.length;Y<G;Y++){let j=C[Y],k=j.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;s.copy(k.mapSize);let et=k.getFrameExtents();if(s.multiply(et),r.copy(k.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/et.x),s.x=r.x*et.x,k.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/et.y),s.y=r.y*et.y,k.mapSize.y=r.y)),k.map===null||O===!0||W===!0){let pt=this.type!==pn?{minFilter:Fe,magFilter:Fe}:{};k.map!==null&&k.map.dispose(),k.map=new xn(s.x,s.y,pt),k.map.texture.name=j.name+".shadowMap",k.camera.updateProjectionMatrix()}i.setRenderTarget(k.map),i.clear();let ct=k.getViewportCount();for(let pt=0;pt<ct;pt++){let St=k.getViewport(pt);a.set(r.x*St.x,r.y*St.y,r.x*St.z,r.y*St.w),z.viewport(a),k.updateMatrices(j,pt),n=k.getFrustum(),M(A,D,k.camera,j,this.type)}k.isPointLightShadow!==!0&&this.type===pn&&b(k,D),k.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,R)};function b(C,A){let D=t.update(_);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new xn(s.x,s.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(A,null,D,f,_,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(A,null,D,m,_,null)}function E(C,A,D,S){let x=null,R=D.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(R!==void 0)x=R;else if(x=D.isPointLight===!0?l:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){let z=x.uuid,O=A.uuid,W=c[z];W===void 0&&(W={},c[z]=W);let Y=W[O];Y===void 0&&(Y=x.clone(),W[O]=Y,A.addEventListener("dispose",U)),x=Y}if(x.visible=A.visible,x.wireframe=A.wireframe,S===pn?x.side=A.shadowSide!==null?A.shadowSide:A.side:x.side=A.shadowSide!==null?A.shadowSide:d[A.side],x.alphaMap=A.alphaMap,x.alphaTest=A.alphaTest,x.map=A.map,x.clipShadows=A.clipShadows,x.clippingPlanes=A.clippingPlanes,x.clipIntersection=A.clipIntersection,x.displacementMap=A.displacementMap,x.displacementScale=A.displacementScale,x.displacementBias=A.displacementBias,x.wireframeLinewidth=A.wireframeLinewidth,x.linewidth=A.linewidth,D.isPointLight===!0&&x.isMeshDistanceMaterial===!0){let z=i.properties.get(x);z.light=D}return x}function M(C,A,D,S,x){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===pn)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,C.matrixWorld);let O=t.update(C),W=C.material;if(Array.isArray(W)){let Y=O.groups;for(let G=0,j=Y.length;G<j;G++){let k=Y[G],et=W[k.materialIndex];if(et&&et.visible){let ct=E(C,et,S,x);C.onBeforeShadow(i,C,A,D,O,ct,k),i.renderBufferDirect(D,null,O,ct,C,k),C.onAfterShadow(i,C,A,D,O,ct,k)}}}else if(W.visible){let Y=E(C,W,S,x);C.onBeforeShadow(i,C,A,D,O,Y,null),i.renderBufferDirect(D,null,O,Y,C,null),C.onAfterShadow(i,C,A,D,O,Y,null)}}let z=C.children;for(let O=0,W=z.length;O<W;O++)M(z[O],A,D,S,x)}function U(C){C.target.removeEventListener("dispose",U);for(let D in c){let S=c[D],x=C.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}var Xg={[Ha]:Ga,[Wa]:Ya,[Xa]:Za,[Ui]:qa,[Ga]:Ha,[Ya]:Wa,[Za]:Xa,[qa]:Ui};function qg(i,t){function e(){let P=!1,st=new ae,H=null,$=new ae(0,0,0,0);return{setMask:function(ht){H!==ht&&!P&&(i.colorMask(ht,ht,ht,ht),H=ht)},setLocked:function(ht){P=ht},setClear:function(ht,ot,Rt,oe,Me){Me===!0&&(ht*=oe,ot*=oe,Rt*=oe),st.set(ht,ot,Rt,oe),$.equals(st)===!1&&(i.clearColor(ht,ot,Rt,oe),$.copy(st))},reset:function(){P=!1,H=null,$.set(-1,0,0,0)}}}function n(){let P=!1,st=!1,H=null,$=null,ht=null;return{setReversed:function(ot){if(st!==ot){let Rt=t.get("EXT_clip_control");st?Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.ZERO_TO_ONE_EXT):Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.NEGATIVE_ONE_TO_ONE_EXT);let oe=ht;ht=null,this.setClear(oe)}st=ot},getReversed:function(){return st},setTest:function(ot){ot?it(i.DEPTH_TEST):Et(i.DEPTH_TEST)},setMask:function(ot){H!==ot&&!P&&(i.depthMask(ot),H=ot)},setFunc:function(ot){if(st&&(ot=Xg[ot]),$!==ot){switch(ot){case Ha:i.depthFunc(i.NEVER);break;case Ga:i.depthFunc(i.ALWAYS);break;case Wa:i.depthFunc(i.LESS);break;case Ui:i.depthFunc(i.LEQUAL);break;case Xa:i.depthFunc(i.EQUAL);break;case qa:i.depthFunc(i.GEQUAL);break;case Ya:i.depthFunc(i.GREATER);break;case Za:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=ot}},setLocked:function(ot){P=ot},setClear:function(ot){ht!==ot&&(st&&(ot=1-ot),i.clearDepth(ot),ht=ot)},reset:function(){P=!1,H=null,$=null,ht=null,st=!1}}}function s(){let P=!1,st=null,H=null,$=null,ht=null,ot=null,Rt=null,oe=null,Me=null;return{setTest:function(qt){P||(qt?it(i.STENCIL_TEST):Et(i.STENCIL_TEST))},setMask:function(qt){st!==qt&&!P&&(i.stencilMask(qt),st=qt)},setFunc:function(qt,Xe,on){(H!==qt||$!==Xe||ht!==on)&&(i.stencilFunc(qt,Xe,on),H=qt,$=Xe,ht=on)},setOp:function(qt,Xe,on){(ot!==qt||Rt!==Xe||oe!==on)&&(i.stencilOp(qt,Xe,on),ot=qt,Rt=Xe,oe=on)},setLocked:function(qt){P=qt},setClear:function(qt){Me!==qt&&(i.clearStencil(qt),Me=qt)},reset:function(){P=!1,st=null,H=null,$=null,ht=null,ot=null,Rt=null,oe=null,Me=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,h={},d={},f=new WeakMap,m=[],g=null,_=!1,p=null,u=null,b=null,E=null,M=null,U=null,C=null,A=new Nt(0,0,0),D=0,S=!1,x=null,R=null,z=null,O=null,W=null,Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,j=0,k=i.getParameter(i.VERSION);k.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(k)[1]),G=j>=1):k.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),G=j>=2);let et=null,ct={},pt=i.getParameter(i.SCISSOR_BOX),St=i.getParameter(i.VIEWPORT),Gt=new ae().fromArray(pt),X=new ae().fromArray(St);function Q(P,st,H,$){let ht=new Uint8Array(4),ot=i.createTexture();i.bindTexture(P,ot),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Rt=0;Rt<H;Rt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(st,0,i.RGBA,1,1,$,0,i.RGBA,i.UNSIGNED_BYTE,ht):i.texImage2D(st+Rt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ht);return ot}let rt={};rt[i.TEXTURE_2D]=Q(i.TEXTURE_2D,i.TEXTURE_2D,1),rt[i.TEXTURE_CUBE_MAP]=Q(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),rt[i.TEXTURE_2D_ARRAY]=Q(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),rt[i.TEXTURE_3D]=Q(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),it(i.DEPTH_TEST),a.setFunc(Ui),Ft(!1),Ot($l),it(i.CULL_FACE),N(Nn);function it(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function Et(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Ct(P,st){return d[P]!==st?(i.bindFramebuffer(P,st),d[P]=st,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=st),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=st),!0):!1}function Ut(P,st){let H=m,$=!1;if(P){H=f.get(st),H===void 0&&(H=[],f.set(st,H));let ht=P.textures;if(H.length!==ht.length||H[0]!==i.COLOR_ATTACHMENT0){for(let ot=0,Rt=ht.length;ot<Rt;ot++)H[ot]=i.COLOR_ATTACHMENT0+ot;H.length=ht.length,$=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,$=!0);$&&i.drawBuffers(H)}function re(P){return g!==P?(i.useProgram(P),g=P,!0):!1}let Vt={[Zn]:i.FUNC_ADD,[su]:i.FUNC_SUBTRACT,[ru]:i.FUNC_REVERSE_SUBTRACT};Vt[au]=i.MIN,Vt[ou]=i.MAX;let le={[lu]:i.ZERO,[cu]:i.ONE,[hu]:i.SRC_COLOR,[za]:i.SRC_ALPHA,[gu]:i.SRC_ALPHA_SATURATE,[pu]:i.DST_COLOR,[du]:i.DST_ALPHA,[uu]:i.ONE_MINUS_SRC_COLOR,[ka]:i.ONE_MINUS_SRC_ALPHA,[mu]:i.ONE_MINUS_DST_COLOR,[fu]:i.ONE_MINUS_DST_ALPHA,[_u]:i.CONSTANT_COLOR,[vu]:i.ONE_MINUS_CONSTANT_COLOR,[yu]:i.CONSTANT_ALPHA,[xu]:i.ONE_MINUS_CONSTANT_ALPHA};function N(P,st,H,$,ht,ot,Rt,oe,Me,qt){if(P===Nn){_===!0&&(Et(i.BLEND),_=!1);return}if(_===!1&&(it(i.BLEND),_=!0),P!==iu){if(P!==p||qt!==S){if((u!==Zn||M!==Zn)&&(i.blendEquation(i.FUNC_ADD),u=Zn,M=Zn),qt)switch(P){case Pi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ni:i.blendFunc(i.ONE,i.ONE);break;case jl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Kl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case Pi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ni:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case jl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Kl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}b=null,E=null,U=null,C=null,A.set(0,0,0),D=0,p=P,S=qt}return}ht=ht||st,ot=ot||H,Rt=Rt||$,(st!==u||ht!==M)&&(i.blendEquationSeparate(Vt[st],Vt[ht]),u=st,M=ht),(H!==b||$!==E||ot!==U||Rt!==C)&&(i.blendFuncSeparate(le[H],le[$],le[ot],le[Rt]),b=H,E=$,U=ot,C=Rt),(oe.equals(A)===!1||Me!==D)&&(i.blendColor(oe.r,oe.g,oe.b,Me),A.copy(oe),D=Me),p=P,S=!1}function Ve(P,st){P.side===Je?Et(i.CULL_FACE):it(i.CULL_FACE);let H=P.side===ye;st&&(H=!H),Ft(H),P.blending===Pi&&P.transparent===!1?N(Nn):N(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let $=P.stencilWrite;o.setTest($),$&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),te(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?it(i.SAMPLE_ALPHA_TO_COVERAGE):Et(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ft(P){x!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),x=P)}function Ot(P){P!==tu?(it(i.CULL_FACE),P!==R&&(P===$l?i.cullFace(i.BACK):P===eu?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Et(i.CULL_FACE),R=P}function bt(P){P!==z&&(G&&i.lineWidth(P),z=P)}function te(P,st,H){P?(it(i.POLYGON_OFFSET_FILL),(O!==st||W!==H)&&(i.polygonOffset(st,H),O=st,W=H)):Et(i.POLYGON_OFFSET_FILL)}function Mt(P){P?it(i.SCISSOR_TEST):Et(i.SCISSOR_TEST)}function w(P){P===void 0&&(P=i.TEXTURE0+Y-1),et!==P&&(i.activeTexture(P),et=P)}function v(P,st,H){H===void 0&&(et===null?H=i.TEXTURE0+Y-1:H=et);let $=ct[H];$===void 0&&($={type:void 0,texture:void 0},ct[H]=$),($.type!==P||$.texture!==st)&&(et!==H&&(i.activeTexture(H),et=H),i.bindTexture(P,st||rt[P]),$.type=P,$.texture=st)}function F(){let P=ct[et];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function Z(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function yt(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function at(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ut(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function zt(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function dt(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function wt(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function At(P){Gt.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Gt.copy(P))}function ft(P){X.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),X.copy(P))}function Bt(P,st){let H=c.get(st);H===void 0&&(H=new WeakMap,c.set(st,H));let $=H.get(P);$===void 0&&($=i.getUniformBlockIndex(st,P.name),H.set(P,$))}function It(P,st){let $=c.get(st).get(P);l.get(st)!==$&&(i.uniformBlockBinding(st,$,P.__bindingPointIndex),l.set(st,$))}function Kt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},et=null,ct={},d={},f=new WeakMap,m=[],g=null,_=!1,p=null,u=null,b=null,E=null,M=null,U=null,C=null,A=new Nt(0,0,0),D=0,S=!1,x=null,R=null,z=null,O=null,W=null,Gt.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:it,disable:Et,bindFramebuffer:Ct,drawBuffers:Ut,useProgram:re,setBlending:N,setMaterial:Ve,setFlipSided:Ft,setCullFace:Ot,setLineWidth:bt,setPolygonOffset:te,setScissorTest:Mt,activeTexture:w,bindTexture:v,unbindTexture:F,compressedTexImage2D:Z,compressedTexImage3D:K,texImage2D:dt,texImage3D:wt,updateUBOMapping:Bt,uniformBlockBinding:It,texStorage2D:zt,texStorage3D:J,texSubImage2D:q,texSubImage3D:yt,compressedTexSubImage2D:at,compressedTexSubImage3D:ut,scissor:At,viewport:ft,reset:Kt}}function Zc(i,t,e,n){let s=Yg(n);switch(e){case hh:return i*t;case dh:return i*t;case fh:return i*t*2;case ph:return i*t/s.components*s.byteLength;case ll:return i*t/s.components*s.byteLength;case mh:return i*t*2/s.components*s.byteLength;case cl:return i*t*2/s.components*s.byteLength;case uh:return i*t*3/s.components*s.byteLength;case tn:return i*t*4/s.components*s.byteLength;case hl:return i*t*4/s.components*s.byteLength;case lr:case cr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case hr:case ur:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case to:case no:return Math.max(i,16)*Math.max(t,8)/4;case Qa:case eo:return Math.max(i,8)*Math.max(t,8)/2;case io:case so:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case ro:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case ao:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case oo:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case lo:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case co:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case ho:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case uo:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case fo:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case po:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case mo:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case go:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case _o:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case vo:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case yo:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case xo:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case dr:case Mo:case So:return Math.ceil(i/4)*Math.ceil(t/4)*16;case gh:case bo:return Math.ceil(i/4)*Math.ceil(t/4)*8;case wo:case Eo:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Yg(i){switch(i){case He:case oh:return{byteLength:1,components:1};case ps:case lh:case bs:return{byteLength:2,components:1};case al:case ol:return{byteLength:2,components:4};case Jn:case rl:case mn:return{byteLength:4,components:1};case ch:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Zg(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new vt,h=new WeakMap,d,f=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,v){return m?new OffscreenCanvas(w,v):gs("canvas")}function _(w,v,F){let Z=1,K=Mt(w);if((K.width>F||K.height>F)&&(Z=F/Math.max(K.width,K.height)),Z<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){let q=Math.floor(Z*K.width),yt=Math.floor(Z*K.height);d===void 0&&(d=g(q,yt));let at=v?g(q,yt):d;return at.width=q,at.height=yt,at.getContext("2d").drawImage(w,0,0,q,yt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+q+"x"+yt+")."),at}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),w;return w}function p(w){return w.generateMipmaps}function u(w){i.generateMipmap(w)}function b(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(w,v,F,Z,K=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=v;if(v===i.RED&&(F===i.FLOAT&&(q=i.R32F),F===i.HALF_FLOAT&&(q=i.R16F),F===i.UNSIGNED_BYTE&&(q=i.R8)),v===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.R8UI),F===i.UNSIGNED_SHORT&&(q=i.R16UI),F===i.UNSIGNED_INT&&(q=i.R32UI),F===i.BYTE&&(q=i.R8I),F===i.SHORT&&(q=i.R16I),F===i.INT&&(q=i.R32I)),v===i.RG&&(F===i.FLOAT&&(q=i.RG32F),F===i.HALF_FLOAT&&(q=i.RG16F),F===i.UNSIGNED_BYTE&&(q=i.RG8)),v===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RG8UI),F===i.UNSIGNED_SHORT&&(q=i.RG16UI),F===i.UNSIGNED_INT&&(q=i.RG32UI),F===i.BYTE&&(q=i.RG8I),F===i.SHORT&&(q=i.RG16I),F===i.INT&&(q=i.RG32I)),v===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGB8UI),F===i.UNSIGNED_SHORT&&(q=i.RGB16UI),F===i.UNSIGNED_INT&&(q=i.RGB32UI),F===i.BYTE&&(q=i.RGB8I),F===i.SHORT&&(q=i.RGB16I),F===i.INT&&(q=i.RGB32I)),v===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),F===i.UNSIGNED_INT&&(q=i.RGBA32UI),F===i.BYTE&&(q=i.RGBA8I),F===i.SHORT&&(q=i.RGBA16I),F===i.INT&&(q=i.RGBA32I)),v===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),v===i.RGBA){let yt=K?Br:kt.getTransfer(Z);F===i.FLOAT&&(q=i.RGBA32F),F===i.HALF_FLOAT&&(q=i.RGBA16F),F===i.UNSIGNED_BYTE&&(q=yt===Zt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function M(w,v){let F;return w?v===null||v===Jn||v===Bi?F=i.DEPTH24_STENCIL8:v===mn?F=i.DEPTH32F_STENCIL8:v===ps&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Jn||v===Bi?F=i.DEPTH_COMPONENT24:v===mn?F=i.DEPTH_COMPONENT32F:v===ps&&(F=i.DEPTH_COMPONENT16),F}function U(w,v){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==Fe&&w.minFilter!==an?Math.log2(Math.max(v.width,v.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?v.mipmaps.length:1}function C(w){let v=w.target;v.removeEventListener("dispose",C),D(v),v.isVideoTexture&&h.delete(v)}function A(w){let v=w.target;v.removeEventListener("dispose",A),x(v)}function D(w){let v=n.get(w);if(v.__webglInit===void 0)return;let F=w.source,Z=f.get(F);if(Z){let K=Z[v.__cacheKey];K.usedTimes--,K.usedTimes===0&&S(w),Object.keys(Z).length===0&&f.delete(F)}n.remove(w)}function S(w){let v=n.get(w);i.deleteTexture(v.__webglTexture);let F=w.source,Z=f.get(F);delete Z[v.__cacheKey],a.memory.textures--}function x(w){let v=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(v.__webglFramebuffer[Z]))for(let K=0;K<v.__webglFramebuffer[Z].length;K++)i.deleteFramebuffer(v.__webglFramebuffer[Z][K]);else i.deleteFramebuffer(v.__webglFramebuffer[Z]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[Z])}else{if(Array.isArray(v.__webglFramebuffer))for(let Z=0;Z<v.__webglFramebuffer.length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[Z]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Z=0;Z<v.__webglColorRenderbuffer.length;Z++)v.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[Z]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let F=w.textures;for(let Z=0,K=F.length;Z<K;Z++){let q=n.get(F[Z]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(F[Z])}n.remove(w)}let R=0;function z(){R=0}function O(){let w=R;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),R+=1,w}function W(w){let v=[];return v.push(w.wrapS),v.push(w.wrapT),v.push(w.wrapR||0),v.push(w.magFilter),v.push(w.minFilter),v.push(w.anisotropy),v.push(w.internalFormat),v.push(w.format),v.push(w.type),v.push(w.generateMipmaps),v.push(w.premultiplyAlpha),v.push(w.flipY),v.push(w.unpackAlignment),v.push(w.colorSpace),v.join()}function Y(w,v){let F=n.get(w);if(w.isVideoTexture&&bt(w),w.isRenderTargetTexture===!1&&w.version>0&&F.__version!==w.version){let Z=w.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(F,w,v);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+v)}function G(w,v){let F=n.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+v)}function j(w,v){let F=n.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,v);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+v)}function k(w,v){let F=n.get(w);if(w.version>0&&F.__version!==w.version){Q(F,w,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+v)}let et={[Ka]:i.REPEAT,[jn]:i.CLAMP_TO_EDGE,[Ja]:i.MIRRORED_REPEAT},ct={[Fe]:i.NEAREST,[Pu]:i.NEAREST_MIPMAP_NEAREST,[Is]:i.NEAREST_MIPMAP_LINEAR,[an]:i.LINEAR,[ca]:i.LINEAR_MIPMAP_NEAREST,[Kn]:i.LINEAR_MIPMAP_LINEAR},pt={[Uu]:i.NEVER,[ku]:i.ALWAYS,[Fu]:i.LESS,[_h]:i.LEQUAL,[Ou]:i.EQUAL,[zu]:i.GEQUAL,[Bu]:i.GREATER,[Vu]:i.NOTEQUAL};function St(w,v){if(v.type===mn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===an||v.magFilter===ca||v.magFilter===Is||v.magFilter===Kn||v.minFilter===an||v.minFilter===ca||v.minFilter===Is||v.minFilter===Kn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,et[v.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,et[v.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,et[v.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,ct[v.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,ct[v.minFilter]),v.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,pt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Fe||v.minFilter!==Is&&v.minFilter!==Kn||v.type===mn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Gt(w,v){let F=!1;w.__webglInit===void 0&&(w.__webglInit=!0,v.addEventListener("dispose",C));let Z=v.source,K=f.get(Z);K===void 0&&(K={},f.set(Z,K));let q=W(v);if(q!==w.__cacheKey){K[q]===void 0&&(K[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),K[q].usedTimes++;let yt=K[w.__cacheKey];yt!==void 0&&(K[w.__cacheKey].usedTimes--,yt.usedTimes===0&&S(v)),w.__cacheKey=q,w.__webglTexture=K[q].texture}return F}function X(w,v,F){let Z=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=i.TEXTURE_3D);let K=Gt(w,v),q=v.source;e.bindTexture(Z,w.__webglTexture,i.TEXTURE0+F);let yt=n.get(q);if(q.version!==yt.__version||K===!0){e.activeTexture(i.TEXTURE0+F);let at=kt.getPrimaries(kt.workingColorSpace),ut=v.colorSpace===In?null:kt.getPrimaries(v.colorSpace),zt=v.colorSpace===In||at===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,zt);let J=_(v.image,!1,s.maxTextureSize);J=te(v,J);let dt=r.convert(v.format,v.colorSpace),wt=r.convert(v.type),At=E(v.internalFormat,dt,wt,v.colorSpace,v.isVideoTexture);St(Z,v);let ft,Bt=v.mipmaps,It=v.isVideoTexture!==!0,Kt=yt.__version===void 0||K===!0,P=q.dataReady,st=U(v,J);if(v.isDepthTexture)At=M(v.format===Vi,v.type),Kt&&(It?e.texStorage2D(i.TEXTURE_2D,1,At,J.width,J.height):e.texImage2D(i.TEXTURE_2D,0,At,J.width,J.height,0,dt,wt,null));else if(v.isDataTexture)if(Bt.length>0){It&&Kt&&e.texStorage2D(i.TEXTURE_2D,st,At,Bt[0].width,Bt[0].height);for(let H=0,$=Bt.length;H<$;H++)ft=Bt[H],It?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,wt,ft.data):e.texImage2D(i.TEXTURE_2D,H,At,ft.width,ft.height,0,dt,wt,ft.data);v.generateMipmaps=!1}else It?(Kt&&e.texStorage2D(i.TEXTURE_2D,st,At,J.width,J.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,J.width,J.height,dt,wt,J.data)):e.texImage2D(i.TEXTURE_2D,0,At,J.width,J.height,0,dt,wt,J.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){It&&Kt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,st,At,Bt[0].width,Bt[0].height,J.depth);for(let H=0,$=Bt.length;H<$;H++)if(ft=Bt[H],v.format!==tn)if(dt!==null)if(It){if(P)if(v.layerUpdates.size>0){let ht=Zc(ft.width,ft.height,v.format,v.type);for(let ot of v.layerUpdates){let Rt=ft.data.subarray(ot*ht/ft.data.BYTES_PER_ELEMENT,(ot+1)*ht/ft.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,ot,ft.width,ft.height,1,dt,Rt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,ft.width,ft.height,J.depth,dt,ft.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,At,ft.width,ft.height,J.depth,0,ft.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,ft.width,ft.height,J.depth,dt,wt,ft.data):e.texImage3D(i.TEXTURE_2D_ARRAY,H,At,ft.width,ft.height,J.depth,0,dt,wt,ft.data)}else{It&&Kt&&e.texStorage2D(i.TEXTURE_2D,st,At,Bt[0].width,Bt[0].height);for(let H=0,$=Bt.length;H<$;H++)ft=Bt[H],v.format!==tn?dt!==null?It?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,ft.data):e.compressedTexImage2D(i.TEXTURE_2D,H,At,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,ft.width,ft.height,dt,wt,ft.data):e.texImage2D(i.TEXTURE_2D,H,At,ft.width,ft.height,0,dt,wt,ft.data)}else if(v.isDataArrayTexture)if(It){if(Kt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,st,At,J.width,J.height,J.depth),P)if(v.layerUpdates.size>0){let H=Zc(J.width,J.height,v.format,v.type);for(let $ of v.layerUpdates){let ht=J.data.subarray($*H/J.data.BYTES_PER_ELEMENT,($+1)*H/J.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,J.width,J.height,1,dt,wt,ht)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,dt,wt,J.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,J.width,J.height,J.depth,0,dt,wt,J.data);else if(v.isData3DTexture)It?(Kt&&e.texStorage3D(i.TEXTURE_3D,st,At,J.width,J.height,J.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,dt,wt,J.data)):e.texImage3D(i.TEXTURE_3D,0,At,J.width,J.height,J.depth,0,dt,wt,J.data);else if(v.isFramebufferTexture){if(Kt)if(It)e.texStorage2D(i.TEXTURE_2D,st,At,J.width,J.height);else{let H=J.width,$=J.height;for(let ht=0;ht<st;ht++)e.texImage2D(i.TEXTURE_2D,ht,At,H,$,0,dt,wt,null),H>>=1,$>>=1}}else if(Bt.length>0){if(It&&Kt){let H=Mt(Bt[0]);e.texStorage2D(i.TEXTURE_2D,st,At,H.width,H.height)}for(let H=0,$=Bt.length;H<$;H++)ft=Bt[H],It?P&&e.texSubImage2D(i.TEXTURE_2D,H,0,0,dt,wt,ft):e.texImage2D(i.TEXTURE_2D,H,At,dt,wt,ft);v.generateMipmaps=!1}else if(It){if(Kt){let H=Mt(J);e.texStorage2D(i.TEXTURE_2D,st,At,H.width,H.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,wt,J)}else e.texImage2D(i.TEXTURE_2D,0,At,dt,wt,J);p(v)&&u(Z),yt.__version=q.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function Q(w,v,F){if(v.image.length!==6)return;let Z=Gt(w,v),K=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+F);let q=n.get(K);if(K.version!==q.__version||Z===!0){e.activeTexture(i.TEXTURE0+F);let yt=kt.getPrimaries(kt.workingColorSpace),at=v.colorSpace===In?null:kt.getPrimaries(v.colorSpace),ut=v.colorSpace===In||yt===at?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);let zt=v.isCompressedTexture||v.image[0].isCompressedTexture,J=v.image[0]&&v.image[0].isDataTexture,dt=[];for(let $=0;$<6;$++)!zt&&!J?dt[$]=_(v.image[$],!0,s.maxCubemapSize):dt[$]=J?v.image[$].image:v.image[$],dt[$]=te(v,dt[$]);let wt=dt[0],At=r.convert(v.format,v.colorSpace),ft=r.convert(v.type),Bt=E(v.internalFormat,At,ft,v.colorSpace),It=v.isVideoTexture!==!0,Kt=q.__version===void 0||Z===!0,P=K.dataReady,st=U(v,wt);St(i.TEXTURE_CUBE_MAP,v);let H;if(zt){It&&Kt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,st,Bt,wt.width,wt.height);for(let $=0;$<6;$++){H=dt[$].mipmaps;for(let ht=0;ht<H.length;ht++){let ot=H[ht];v.format!==tn?At!==null?It?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht,0,0,ot.width,ot.height,At,ot.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht,Bt,ot.width,ot.height,0,ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht,0,0,ot.width,ot.height,At,ft,ot.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht,Bt,ot.width,ot.height,0,At,ft,ot.data)}}}else{if(H=v.mipmaps,It&&Kt){H.length>0&&st++;let $=Mt(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,st,Bt,$.width,$.height)}for(let $=0;$<6;$++)if(J){It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,dt[$].width,dt[$].height,At,ft,dt[$].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Bt,dt[$].width,dt[$].height,0,At,ft,dt[$].data);for(let ht=0;ht<H.length;ht++){let Rt=H[ht].image[$].image;It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht+1,0,0,Rt.width,Rt.height,At,ft,Rt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht+1,Bt,Rt.width,Rt.height,0,At,ft,Rt.data)}}else{It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,At,ft,dt[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Bt,At,ft,dt[$]);for(let ht=0;ht<H.length;ht++){let ot=H[ht];It?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht+1,0,0,At,ft,ot.image[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ht+1,Bt,At,ft,ot.image[$])}}}p(v)&&u(i.TEXTURE_CUBE_MAP),q.__version=K.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function rt(w,v,F,Z,K,q){let yt=r.convert(F.format,F.colorSpace),at=r.convert(F.type),ut=E(F.internalFormat,yt,at,F.colorSpace),zt=n.get(v),J=n.get(F);if(J.__renderTarget=v,!zt.__hasExternalTextures){let dt=Math.max(1,v.width>>q),wt=Math.max(1,v.height>>q);K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?e.texImage3D(K,q,ut,dt,wt,v.depth,0,yt,at,null):e.texImage2D(K,q,ut,dt,wt,0,yt,at,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),Ot(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,K,J.__webglTexture,0,Ft(v)):(K===i.TEXTURE_2D||K>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,K,J.__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function it(w,v,F){if(i.bindRenderbuffer(i.RENDERBUFFER,w),v.depthBuffer){let Z=v.depthTexture,K=Z&&Z.isDepthTexture?Z.type:null,q=M(v.stencilBuffer,K),yt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,at=Ft(v);Ot(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at,q,v.width,v.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,at,q,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,q,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,yt,i.RENDERBUFFER,w)}else{let Z=v.textures;for(let K=0;K<Z.length;K++){let q=Z[K],yt=r.convert(q.format,q.colorSpace),at=r.convert(q.type),ut=E(q.internalFormat,yt,at,q.colorSpace),zt=Ft(v);F&&Ot(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,zt,ut,v.width,v.height):Ot(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,zt,ut,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ut,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Et(w,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let Z=n.get(v.depthTexture);Z.__renderTarget=v,(!Z.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Y(v.depthTexture,0);let K=Z.__webglTexture,q=Ft(v);if(v.depthTexture.format===Di)Ot(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(v.depthTexture.format===Vi)Ot(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function Ct(w){let v=n.get(w),F=w.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==w.depthTexture){let Z=w.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Z){let K=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Z.removeEventListener("dispose",K)};Z.addEventListener("dispose",K),v.__depthDisposeCallback=K}v.__boundDepthTexture=Z}if(w.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Et(v.__webglFramebuffer,w)}else if(F){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]===void 0)v.__webglDepthbuffer[Z]=i.createRenderbuffer(),it(v.__webglDepthbuffer[Z],w,!1);else{let K=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,K,i.RENDERBUFFER,q)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),it(v.__webglDepthbuffer,w,!1);else{let Z=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,K=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,K),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,K)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ut(w,v,F){let Z=n.get(w);v!==void 0&&rt(Z.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Ct(w)}function re(w){let v=w.texture,F=n.get(w),Z=n.get(v);w.addEventListener("dispose",A);let K=w.textures,q=w.isWebGLCubeRenderTarget===!0,yt=K.length>1;if(yt||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=v.version,a.memory.textures++),q){F.__webglFramebuffer=[];for(let at=0;at<6;at++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[at]=[];for(let ut=0;ut<v.mipmaps.length;ut++)F.__webglFramebuffer[at][ut]=i.createFramebuffer()}else F.__webglFramebuffer[at]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let at=0;at<v.mipmaps.length;at++)F.__webglFramebuffer[at]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(yt)for(let at=0,ut=K.length;at<ut;at++){let zt=n.get(K[at]);zt.__webglTexture===void 0&&(zt.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&Ot(w)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let at=0;at<K.length;at++){let ut=K[at];F.__webglColorRenderbuffer[at]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[at]);let zt=r.convert(ut.format,ut.colorSpace),J=r.convert(ut.type),dt=E(ut.internalFormat,zt,J,ut.colorSpace,w.isXRRenderTarget===!0),wt=Ft(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,wt,dt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+at,i.RENDERBUFFER,F.__webglColorRenderbuffer[at])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),it(F.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),St(i.TEXTURE_CUBE_MAP,v);for(let at=0;at<6;at++)if(v.mipmaps&&v.mipmaps.length>0)for(let ut=0;ut<v.mipmaps.length;ut++)rt(F.__webglFramebuffer[at][ut],w,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,ut);else rt(F.__webglFramebuffer[at],w,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(v)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(yt){for(let at=0,ut=K.length;at<ut;at++){let zt=K[at],J=n.get(zt);e.bindTexture(i.TEXTURE_2D,J.__webglTexture),St(i.TEXTURE_2D,zt),rt(F.__webglFramebuffer,w,zt,i.COLOR_ATTACHMENT0+at,i.TEXTURE_2D,0),p(zt)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let at=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(at=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(at,Z.__webglTexture),St(at,v),v.mipmaps&&v.mipmaps.length>0)for(let ut=0;ut<v.mipmaps.length;ut++)rt(F.__webglFramebuffer[ut],w,v,i.COLOR_ATTACHMENT0,at,ut);else rt(F.__webglFramebuffer,w,v,i.COLOR_ATTACHMENT0,at,0);p(v)&&u(at),e.unbindTexture()}w.depthBuffer&&Ct(w)}function Vt(w){let v=w.textures;for(let F=0,Z=v.length;F<Z;F++){let K=v[F];if(p(K)){let q=b(w),yt=n.get(K).__webglTexture;e.bindTexture(q,yt),u(q),e.unbindTexture()}}}let le=[],N=[];function Ve(w){if(w.samples>0){if(Ot(w)===!1){let v=w.textures,F=w.width,Z=w.height,K=i.COLOR_BUFFER_BIT,q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,yt=n.get(w),at=v.length>1;if(at)for(let ut=0;ut<v.length;ut++)e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,yt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer);for(let ut=0;ut<v.length;ut++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(K|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(K|=i.STENCIL_BUFFER_BIT)),at){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,yt.__webglColorRenderbuffer[ut]);let zt=n.get(v[ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,zt,0)}i.blitFramebuffer(0,0,F,Z,0,0,F,Z,K,i.NEAREST),l===!0&&(le.length=0,N.length=0,le.push(i.COLOR_ATTACHMENT0+ut),w.depthBuffer&&w.resolveDepthBuffer===!1&&(le.push(q),N.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,N)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,le))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),at)for(let ut=0;ut<v.length;ut++){e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,yt.__webglColorRenderbuffer[ut]);let zt=n.get(v[ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,zt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){let v=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Ft(w){return Math.min(s.maxSamples,w.samples)}function Ot(w){let v=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function bt(w){let v=a.render.frame;h.get(w)!==v&&(h.set(w,v),w.update())}function te(w,v){let F=w.colorSpace,Z=w.format,K=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||F!==qi&&F!==In&&(kt.getTransfer(F)===Zt?(Z!==tn||K!==He)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function Mt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=z,this.setTexture2D=Y,this.setTexture2DArray=G,this.setTexture3D=j,this.setTextureCube=k,this.rebindTextures=Ut,this.setupRenderTarget=re,this.updateRenderTargetMipmap=Vt,this.updateMultisampleRenderTarget=Ve,this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=Ot}function $g(i,t){function e(n,s=In){let r,a=kt.getTransfer(s);if(n===He)return i.UNSIGNED_BYTE;if(n===al)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ol)return i.UNSIGNED_SHORT_5_5_5_1;if(n===ch)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===oh)return i.BYTE;if(n===lh)return i.SHORT;if(n===ps)return i.UNSIGNED_SHORT;if(n===rl)return i.INT;if(n===Jn)return i.UNSIGNED_INT;if(n===mn)return i.FLOAT;if(n===bs)return i.HALF_FLOAT;if(n===hh)return i.ALPHA;if(n===uh)return i.RGB;if(n===tn)return i.RGBA;if(n===dh)return i.LUMINANCE;if(n===fh)return i.LUMINANCE_ALPHA;if(n===Di)return i.DEPTH_COMPONENT;if(n===Vi)return i.DEPTH_STENCIL;if(n===ph)return i.RED;if(n===ll)return i.RED_INTEGER;if(n===mh)return i.RG;if(n===cl)return i.RG_INTEGER;if(n===hl)return i.RGBA_INTEGER;if(n===lr||n===cr||n===hr||n===ur)if(a===Zt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===lr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===cr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===hr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===lr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===cr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===hr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ur)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Qa||n===to||n===eo||n===no)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Qa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===to)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===eo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===no)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===io||n===so||n===ro)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===io||n===so)return a===Zt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ro)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ao||n===oo||n===lo||n===co||n===ho||n===uo||n===fo||n===po||n===mo||n===go||n===_o||n===vo||n===yo||n===xo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ao)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===oo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===lo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===co)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ho)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===uo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===fo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===po)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===mo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===go)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===_o)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===vo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===yo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===xo)return a===Zt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===dr||n===Mo||n===So)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===dr)return a===Zt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Mo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===So)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===gh||n===bo||n===wo||n===Eo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===dr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===bo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===wo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Eo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Bi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var Ho=class extends Ce{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}},en=class extends Ee{constructor(){super(),this.isGroup=!0,this.type="Group"}},jg={type:"move"},fs=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new en,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new en,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new T,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new T),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new en,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new T,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new T),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){let e=this._hand;if(e)for(let n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,a=null,o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(let _ of t.hand.values()){let p=e.getJointPose(_,n),u=this._getHandJoint(c,_);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}let h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],f=h.position.distanceTo(d.position),m=.02,g=.005;c.inputState.pinching&&f>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&f<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(o.matrix.fromArray(s.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,s.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(s.linearVelocity)):o.hasLinearVelocity=!1,s.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(s.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(jg)))}return o!==null&&(o.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){let n=new en;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}},Kg=`
void main() {
...
`,zh=new Ge,Be=class extends se{constructor(t,e,n,s){let r={v3LightPosition:{type:"v3",value:new T(1,0,0)},day_Texture:{type:"t",value:null},night_Texture:{type:"t",value:null}},a=new xe({uniforms:r,vertexShader:I_,fragmentShader:L_}),o=new On(t,64,64);super(o,a),this.r=t,this.colorHex=e,this.sunvect=new T(1,0,0);let l=R_(e),c=new xe({vertexShader:P_,fragmentShader:D_,uniforms:{v3LightPosition:{value:new T(1,0,0)},cps:{value:n.position},color:{value:new T(l[0],l[1],l[2])}},side:ye,transparent:!0,depthWrite:!1});this.atm=new se(new On(t*1.01,64,64),c),s.add(this.atm);let h=this.r*1.5,d=new ai(new T(0,1,0),new T(0,0,0),h,e);this.add(d)}loadTextures(t,e,n=16){let s=zh.load(t),r=zh.load(e);s.anisotropy=n,r.anisotropy=n}setSun(t){this.sunvect.copy(t)}setSunOrigin(){this.sunvect.copy(this.position),this.sunvect.normalize().negate()}setPosition(t,e,n){this.position.set(t,e,n)}setTilt(t){this.rotation.x=t}init(t,e,n,s,r){this.loadTextures(t,e),this.setPosition(n[0],n[1],n[2]),this.setSunOrigin(),this.spriteRing=new Hi(new ii({map:r,color:this.colorHex,depthTest:!1})),this.add(this.spriteRing),this.setTilt(s)}initWithoutRing(t,e,n,s){this.loadTextures(t,e),this.setPosition(n[0],n[1],n[2]),this.setSunOrigin(),this.setTilt(s)}updateFromRK4(t,e){this.position.set(t.x,t.y,t.z),this.atm.position.set(t.x,t.y,t.z),this.rotation.y+=e,this.setSunOrigin()}};var N_=66743e-24,U_=1e-21;function Wr(i){let t=i.map(()=>({ax:0,ay:0,az:0}));for(let e=0;e<i.length;e++)for(let n=e+1;n<i.length;n++){let s=i[n].x-i[e].x,r=i[n].y-i[e].y,a=i[n].z-i[e].z,o=Math.sqrt(s*s+r*r+a*a);if(o===0)continue;let l=U_*(N_*i[e].mass*i[n].mass)/(o*o),c=l*s/(o*i[e].mass),h=l*r/(o*i[e].mass),d=l*a/(o*i[e].mass);t[e].ax+=c,t[e].ay+=h,t[e].az+=d,t[n].ax-=c*(i[e].mass/i[n].mass),t[n].ay-=h*(i[e].mass/i[n].mass),t[n].az-=d*(i[e].mass/i[n].mass)}return t}function F_(i){return i.map(t=>({x:t.x,y:t.y,z:t.z,vx:t.vx,vy:t.vy,vz:t.vz,mass:t.mass}))}function _l(i,t,e){return i.map((n,s)=>({x:n.x+t[s].vx*e,y:n.y+t[s].vy*e,z:n.z+t[s].vz*e,vx:n.vx+t[s].ax*e,vy:n.vy+t[s].ay*e,vz:n.vz+t[s].az*e,mass:n.mass}))}function vl(i,t){let e=F_(i),n=Wr(e),s=e.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:n[_].ax,ay:n[_].ay,az:n[_].az})),r=_l(e,s,t/2),a=Wr(r),o=r.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:a[_].ax,ay:a[_].ay,az:a[_].az})),l=_l(e,o,t/2),c=Wr(l),h=l.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:c[_].ax,ay:c[_].ay,az:c[_].az})),d=_l(e,h,t),f=Wr(d),m=d.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:f[_].ax,ay:f[_].ay,az:f[_].az}));i.forEach((g,_)=>{g.x+=t/6*(s[_].vx+2*o[_].vx+2*h[_].vx+m[_].vx),g.y+=t/6*(s[_].vy+2*o[_].vy+2*h[_].vy+m[_].vy),g.z+=t/6*(s[_].vz+2*o[_].vz+2*h[_].vz+m[_].vz),g.vx+=t/6*(s[_].ax+2*o[_].ax+2*h[_].ax+m[_].ax),g.vy+=t/6*(s[_].ay+2*o[_].ay+2*h[_].ay+m[_].ay),g.vz+=t/6*(s[_].az+2*o[_].az+2*h[_].az+m[_].az)})}var Es=class i extends se{constructor(){super(i.Geometry,new Sn({opacity:0,transparent:!0})),this.isLensflare=!0,this.type="Lensflare",this.frustumCulled=!1,this.renderOrder=1/0;let t=new T,e=new T,n=new Ms(16,16),s=new Ms(16,16),r=He,a=i.Geometry,o=new Wi({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
		...
		}`},i})();Es.Geometry=function(){let i=new fe,t=new Float32Array([-1,-1,0,0,0,1,-1,0,1,0,1,1,0,1,1,-1,1,0,0,1]),e=new vs(t,5);return i.setIndex([0,1,2,0,2,3]),i.setAttribute("position",new ni(e,3,0,!1)),i.setAttribute("uv",new ni(e,2,3,!1)),i}();var Xr=class extends Es{constructor(){super(),this.dirlight=new Lr(16755200,43775,1),this.textureLoader=new Ge,this.posNorm=new T,this.add(this.dirlight)}loadFlare(t,e,n){let s=this.textureLoader.load(t);this.addElement(new yl(s,e,n))}setPosition(t,e,n){this.position.set(t,e,n),this.dirlight.position.set(t,e,n),this.posNorm.copy(this.position),this.posNorm.normalize()}setModelOne(t,e,n){this.loadFlare(t,500/3,0),this.loadFlare(n,120,1),this.loadFlare(e,20,.96),this.loadFlare(e,60,.95),this.loadFlare(n,140,.85)}};function xl(){for(var i=0,t=0;t<6;t+=1)i+=Math.random();return i/6*2-1}var qr=class extends Pr{constructor(t,e=null){let a=[[.678,.847,.902],[1,.784,.588],[1,1,1]],o=[],l=[],c=[],h=[],d=new T;for(let g=0;g<t;g++){d.set(xl(),xl(),xl()),d.normalize().multiplyScalar(1e3),l.push(d.x,d.y,d.z);let _=Math.floor(Math.random()*a.length),p=a[_];o.push(p[0],p[1],p[2]),c.push(1),h.push(2*Math.random()+1)}let f=new fe;f.setAttribute("position",new jt(l,3)),f.setAttribute("color",new jt(o,3));let m=new xs({map:e,size:5,blending:Ni,vertexColors:!0,transparent:!0,depthWrite:!1});m.onBeforeCompile=function(g){g.vertexShader=`
