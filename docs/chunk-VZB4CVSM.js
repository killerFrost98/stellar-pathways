...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Rc(){return new xe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dl(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Pc(){return new xe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Eg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===rh?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===nu?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===pn&&(t="SHADOWMAP_TYPE_VSM"),t}function Ag(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Oi:case Bi:t="ENVMAP_TYPE_CUBE";break;case Vr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Tg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Bi:t="ENVMAP_MODE_REFRACTION";break}return t}function Cg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ah:t="ENVMAP_BLENDING_MULTIPLY";break;case Mu:t="ENVMAP_BLENDING_MIX";break;case Su:t="ENVMAP_BLENDING_ADD";break}return t}function Rg(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Pg(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,l=Eg(e),c=Ag(e),h=Tg(e),d=Cg(e),f=Rg(e),m=_g(e),g=vg(r),_=s.createProgram(),p,u,b=e.glslVersion?"#version "+e.glslVersion+`
...
`,zh=new Ge,Be=class extends se{constructor(t,e,n,s){let r={v3LightPosition:{type:"v3",value:new T(1,0,0)},day_Texture:{type:"t",value:null},night_Texture:{type:"t",value:null}},a=new xe({uniforms:r,vertexShader:L_,fragmentShader:N_}),o=new Bn(t,64,64);super(o,a),this.r=t,this.colorHex=e,this.sunvect=new T(1,0,0);let l=P_(e),c=new xe({vertexShader:D_,fragmentShader:I_,uniforms:{v3LightPosition:{value:new T(1,0,0)},cps:{value:n.position},color:{value:new T(l[0],l[1],l[2])}},side:ye,transparent:!0,depthWrite:!1});this.atm=new se(new Bn(t*1.01,64,64),c),s.add(this.atm);let h=this.r*1.5,d=new oi(new T(0,1,0),new T(0,0,0),h,e);this.add(d)}loadTextures(t,e,n=16){let s=zh.load(t),r=zh.load(e);s.anisotropy=n,r.anisotropy=n,this.material.uniforms.day_Texture.value=s,this.material.uniforms.night_Texture.value=r}setSun(t){this.sunvect.copy(t),this.material.uniforms.v3LightPosition.value=this.sunvect,this.atm.material.uniforms.v3LightPosition.value=this.sunvect}setSunOrigin(){this.sunvect.copy(this.position),this.sunvect.normalize().negate(),this.material.uniforms.v3LightPosition.value=this.sunvect,this.atm.material.uniforms.v3LightPosition.value=this.sunvect}setPosition(t,e,n){this.position.set(t,e,n)}setTilt(t){this.rotation.x=t}init(t,e,n,s,r){this.loadTextures(t,e),this.setPosition(n[0],n[1],n[2]),this.setSunOrigin(),this.spriteRing=new Gi(new si({map:r,color:this.colorHex,depthTest:!1})),this.add(this.spriteRing),this.setTilt(s)}initWithoutRing(t,e,n,s){this.loadTextures(t,e),this.setPosition(n[0],n[1],n[2]),this.setSunOrigin(),this.setTilt(s)}updateFromRK4(t,e){this.position.set(t.x,t.y,t.z),this.atm.position.set(t.x,t.y,t.z),this.rotation.y+=e,this.setSunOrigin()}};var U_=66743e-24,F_=1e-21;function qr(i){let t=i.map(()=>({ax:0,ay:0,az:0}));for(let e=0;e<i.length;e++)for(let n=e+1;n<i.length;n++){let s=i[n].x-i[e].x,r=i[n].y-i[e].y,a=i[n].z-i[e].z,o=Math.sqrt(s*s+r*r+a*a);if(o===0)continue;let l=F_*(U_*i[e].mass*i[n].mass)/(o*o),c=l*s/(o*i[e].mass),h=l*r/(o*i[e].mass),d=l*a/(o*i[e].mass);t[e].ax+=c,t[e].ay+=h,t[e].az+=d,t[n].ax-=c*(i[e].mass/i[n].mass),t[n].ay-=h*(i[e].mass/i[n].mass),t[n].az-=d*(i[e].mass/i[n].mass)}return t}function O_(i){return i.map(t=>({x:t.x,y:t.y,z:t.z,vx:t.vx,vy:t.vy,vz:t.vz,mass:t.mass}))}function _l(i,t,e){return i.map((n,s)=>({x:n.x+t[s].vx*e,y:n.y+t[s].vy*e,z:n.z+t[s].vz*e,vx:n.vx+t[s].ax*e,vy:n.vy+t[s].ay*e,vz:n.vz+t[s].az*e,mass:n.mass}))}function vl(i,t){let e=O_(i),n=qr(e),s=e.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:n[_].ax,ay:n[_].ay,az:n[_].az})),r=_l(e,s,t/2),a=qr(r),o=r.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:a[_].ax,ay:a[_].ay,az:a[_].az})),l=_l(e,o,t/2),c=qr(l),h=l.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:c[_].ax,ay:c[_].ay,az:c[_].az})),d=_l(e,h,t),f=qr(d),m=d.map((g,_)=>({vx:g.vx,vy:g.vy,vz:g.vz,ax:f[_].ax,ay:f[_].ay,az:f[_].az}));i.forEach((g,_)=>{g.x+=t/6*(s[_].vx+2*o[_].vx+2*h[_].vx+m[_].vx),g.y+=t/6*(s[_].vy+2*o[_].vy+2*h[_].vy+m[_].vy),g.z+=t/6*(s[_].vz+2*o[_].vz+2*h[_].vz+m[_].vz),g.vx+=t/6*(s[_].ax+2*o[_].ax+2*h[_].ax+m[_].ax),g.vy+=t/6*(s[_].ay+2*o[_].ay+2*h[_].ay+m[_].ay),g.vz+=t/6*(s[_].az+2*o[_].az+2*h[_].az+m[_].az)})}var Es=class i extends se{constructor(){super(i.Geometry,new Sn({opacity:0,transparent:!0})),this.isLensflare=!0,this.type="Lensflare",this.frustumCulled=!1,this.renderOrder=1/0;let t=new T,e=new T,n=new Ms(16,16),s=new Ms(16,16),r=He,a=i.Geometry,o=new Xi({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
				...
				}`,depthTest:!0,depthWrite:!1,transparent:!1}),l=new Xi({uniforms:{map:{value:n},scale:{value:null},screenPosition:{value:null}},vertexShader:`
		...
		}`},i})();Es.Geometry=function(){let i=new pe,t=new Float32Array([-1,-1,0,0,0,1,-1,0,1,0,1,1,0,1,1,-1,1,0,0,1]),e=new vs(t,5);return i.setIndex([0,1,2,0,2,3]),i.setAttribute("position",new ii(e,3,0,!1)),i.setAttribute("uv",new ii(e,2,3,!1)),i}();var Yr=class extends Es{constructor(){super(),this.dirlight=new Ur(16755200,43775,1),this.textureLoader=new Ge,this.posNorm=new T,this.add(this.dirlight)}loadFlare(t,e,n){let s=this.textureLoader.load(t);this.addElement(new yl(s,e,n))}setPosition(t,e,n){this.position.set(t,e,n),this.dirlight.position.set(t,e,n),this.posNorm.copy(this.position),this.posNorm.normalize()}setModelOne(t,e,n){this.loadFlare(t,500/3,0),this.loadFlare(n,120,1),this.loadFlare(e,20,.96),this.loadFlare(e,60,.95),this.loadFlare(n,140,.85)}};function xl(){for(var i=0,t=0;t<6;t+=1)i+=Math.random();return i/6*2-1}var Zr=class extends Ir{constructor(t,e=null){let a=[[.678,.847,.902],[1,.784,.588],[1,1,1]],o=[],l=[],c=[],h=[],d=new T;for(let g=0;g<t;g++){d.set(xl(),xl(),xl()),d.normalize().multiplyScalar(1e3),l.push(d.x,d.y,d.z);let _=Math.floor(Math.random()*a.length),p=a[_];o.push(p[0],p[1],p[2]),c.push(1),h.push(2*Math.random()+1)}let f=new pe;f.setAttribute("position",new jt(l,3)),f.setAttribute("color",new jt(o,3));let m=new xs({map:e,size:5,blending:Ui,vertexColors:!0,transparent:!0,depthWrite:!1});m.onBeforeCompile=function(g){g.vertexShader=`
